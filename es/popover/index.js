...
var componentClassName = createClassName('popover');
var Popover = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function Popover() {
    ...
    _this.renderPopup = function () {
      ...
      return /*#__PURE__*/React.createElement(React.Fragment, null, visibleArrow ? ( /*#__PURE__*/React.createElement("div", {
        style: style3Use,
  ...
  _createClass(Popover, [{
    ...
    value: function render() {
      ...
      var className2Use = classnames(componentClassName, className, _defineProperty({}, "".concat(componentClassName, "--").concat(theme), theme));
