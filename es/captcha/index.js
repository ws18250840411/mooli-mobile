...
var componentClassName = createClassName('captcha');
var Captcha = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(Captcha, [{
    ...
    value: function renderPanel() {
      ...
      var captchaClassName = createClassName(componentClassName, 'panel');
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        className: createClassName(captchaClassName, 'placeholder')
      }, !loading && ( /*#__PURE__*/React.createElement("div", {
        className: createClassName(captchaClassName, 'bg-slider')
        ...
        className: createClassName(captchaClassName, 'loading-wrap')
