...
var Row = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(Row, [{
    ...
    value: function render() {
      ...
      var componentClassName = createClassName('row');
      var className2Use = classnames(componentClassName, className, _defineProperty(_defineProperty(_defineProperty({}, "".concat(componentClassName, "--align"), align), "".concat(componentClassName, "--flex ").concat(componentClassName, "--justify-").concat(justify), justify), "".concat(componentClassName, "--no-wrap"), !wrap));
      var style2Use = {};
