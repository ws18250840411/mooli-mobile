...
var componentClassName = createClassName('uploader');
var getClassName = function getClassName(name) {
  return createClassName(componentClassName, name);
};
var Uploader = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function Uploader(props) {
    ...
    _this.readFile = function (files) {
      ...
      var oversize = isOversize(files, maxSize);
      if (Array.isArray(files)) {
        ...
        Promise.all(files.map(function (file) {
          return fileReader(file, resultType);
        ...
        fileReader(files, resultType).then(function (content) {
          var result = {
            file: files,
            status: '',
            message: ''
    ...
    _this.onPreviewImage = function (item) {
      ...
      if (imageContents) {
        _this.imagePreview = ImagePreview.create(Object.assign({
    ...
    _this.genPreviewItem = function (item, index) {
      ...
      var IsImageFile = isImageFile(item);
      ...
      var PreviewMask = function PreviewMask() {
        ...
        if (status === 'uploading' || status === 'failed') {
          var MaskIcon = status === 'failed' ? ( /*#__PURE__*/React.createElement(Icon, {
            name: "close",
      ...
      var Preview = IsImageFile ? ( /*#__PURE__*/React.createElement(Image, {
        fit: curImageFit,
    ...
    _this.genUpload = function () {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        style: curStyle
      }, uploadIcon || ( /*#__PURE__*/React.createElement(Icon, {
        name: uploadIconName,
  ...
  _createClass(Uploader, [{
    ...
    value: function render() {
      ...
      var className2Use = classnames(wrapperClassName, className, _defineProperty({}, "".concat(componentClassName, "--disabled"), disabled));
      return /*#__PURE__*/React.createElement("div", {
