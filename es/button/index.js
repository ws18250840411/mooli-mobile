...
export var btype = ['default', 'primary', 'info', 'warning', 'danger'];
export var bsize = ['large', 'normal', 'small', 'mini'];
export var iconpositions = ['top', 'left', 'right', 'bottom'];
var htmlTypes = ['button', 'reset', 'submit'];
var componentClassName = createClassName('button');
...
var Button = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(Button, [{
    ...
    value: function renderIcon() {
      ...
      if (loading) {
        var loadingClassName = createClassName(contentClassName, 'loading');
      ...
      if (icon) {
        var iconClassName = createClassName(contentClassName, 'icon');
        if (isString(icon)) {
    ...
    value: function renderContent() {
      ...
      var textClassName = createClassName(contentClassName, 'text');
    ...
    value: function render() {
      ...
      var className2Use = classnames(componentClassName, className, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "".concat(componentClassName, "--").concat(type), btype.some(function (t) {
        return t === type;
...
Button.propTypes = {
  type: PropTypes.oneOf([].concat(btype)),
  size: PropTypes.oneOf([].concat(bsize)),
