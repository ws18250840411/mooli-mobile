...
export default function getPosition(targetDom, popupDom, options) {
  ...
  var offsets = {};
  var targetClientRect = getClientRect(targetDom);
  var placementObj = getPlacement(placement, offset);
  ...
  var popupClientRect = getClientRect(popupDom);
