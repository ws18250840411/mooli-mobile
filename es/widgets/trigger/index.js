...
export function feedbackToPlacement(feedback) {
  var map = {
...
export var Trigger = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Trigger, [{
        ...
        if (!this.clickOutsideHandler && (this.isMouseDownToHide() || this.isClickToHide() || this.isContextMenuToShow())) {
          if (Array.isArray(outsideHideEventName)) {
            ...
            outsideHideEventName.forEach(function (name) {
              cancelHandlers.push(listen(currentDocument, name, _this2.onOutsideClickToHide));
            });
            ...
            this.clickOutsideHandler = listen(currentDocument, outsideHideEventName, this.onOutsideClickToHide);
          }
        }
        // 滚动或者窗口失焦/重置等都需要隐藏popup
        if (!this.contextMenuOutsideHandler1 && this.isContextMenuToShow()) {
          this.contextMenuOutsideHandler1 = listen(currentDocument, 'scroll', this.onContextMenuClose);
        }
    ...
    value: function addPlacementClassName(popupNode, feedback) {
      ...
      addClass(popupNode, "".concat(prefixCls, "-placement-").concat(feedbackToPlacement(feedback)));
    }
    // 设置popup位置
  }, {
    ...
    value: function setPopupPosition(popupRootNode) {
      ...
      var _getPosition = getPosition(triggerNode, popupRootNode, {
          placement: placement,
          offset: offset
        }),
    ...
    value: function render() {
      ...
      var trigger = /*#__PURE__*/React.cloneElement(child, this.genNewChildProps(child));
      var popup = this.getPopupComponent();
      if (usePortal) popup = /*#__PURE__*/React.createElement(Portal, {
