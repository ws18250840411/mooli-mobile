...
var componentClassName = createClassName('bcaptcha');
var BACKDROPWIDTH = 248;
var BCaptcha = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(BCaptcha, [{
    ...
    value: function renderResult() {
      ...
      if (status) {
        var resultClassName = createClassName(componentClassName, 'result');
        var className3Use = classnames(resultClassName, _defineProperty({}, "".concat(resultClassName, "--").concat(status), true));
        ...
        return /*#__PURE__*/React.createElement(Overlay, {
          ...
          className: createClassName(resultClassName, 'icon')
        }), /*#__PURE__*/React.createElement("p", {
          className: createClassName(resultClassName, 'descript')
        }, text())));
      }
      return null;
    }
    ...
    value: function render() {
      ...
      var node = /*#__PURE__*/React.createElement(Popup, {
        ...
        className: createClassName(componentClassName, 'frequency')
