...
import Key from './key';
var componentClassName = createClassName('number-keyboard');
var NumberKeyboard = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function NumberKeyboard() {
    ...
    _this.renderTitle = function () {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        className: createClassName(headerClassName, 'title')
    ...
    _this.renderContent = function () {
      var contentClassName = createClassName(componentClassName, 'body');
      return /*#__PURE__*/React.createElement("div", {
        className: contentClassName
      }, _this.renderKeys(), _this.renderSidebar());
    };
    _this.renderKeys = function () {
      var keysClassName = createClassName(componentClassName, 'keys');
      return /*#__PURE__*/React.createElement("div", {
    ...
    _this.renderSidebar = function () {
      ...
      if (theme === 'custom') {
        var contentClassName = createClassName(componentClassName, 'sidebar');
        return /*#__PURE__*/React.createElement("div", {
          className: contentClassName
        }, showDeleteButtonIcon && ( /*#__PURE__*/React.createElement(Key, {
          large: true,
          text: deleteButtonText,
          type: "delete",
          onPress: _this.onPress
  ...
  _createClass(NumberKeyboard, [{
    ...
    value: function render() {
      ...
      var className2Use = classnames(componentClassName, className, _defineProperty({}, "".concat(componentClassName, "--with-title"), showTitle));
