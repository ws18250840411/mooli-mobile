...
var componentClassName = createClassName('index-bar');
var IndexBar = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function IndexBar(props, context) {
    ...
    _this.onScroll = function () {
      if (_this.rootRef.current && isHidden(_this.rootRef.current)) {
        return;
      }
      if (_this.scroller) {
        ...
        var scrollTop = getScrollTop(_this.scroller);
  ...
  _createClass(IndexBar, [{
    ...
    value: function renderIndex() {
      ...
      var tipsClassName = createClassName(componentClassName, 'tips');
      indexList.forEach(function (index) {
        var active = index === _this2.state.activeAnchorIndex;
        var className2Use = classnames(indexClassName, _defineProperty({}, "".concat(indexClassName, "--active"), active));
    ...
    value: function render() {
      ...
      var sidebarClassName = createClassName(componentClassName, 'sidebar');
      var sidebarInnerClassName = createClassName(componentClassName, 'sidebar-inner');
