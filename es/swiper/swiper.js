...
import MooliCarousel from 'mooli-carousel';
import { canUseDOM } from './lib/utils';
import { createClassName, isBoolean, raf, cancelRaf } from '../utils';
function isImage(name) {
  return name ? name.indexOf('/') !== -1 : false;
}
var componentClassName = createClassName('swiper');
var AUTOPLAY_INTERVAL = 4000;
var Swiper = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function Swiper(props) {
    ...
    _this.initViewport = function () {
      ...
      _this.embla = MooliCarousel(_this.viewportRef.current, viewportOptions);
    ...
    _this.initThumbViewport = function () {
      ...
      _this.emblaThumbs = MooliCarousel(_this.thumbViewportRef.current, thumbViewportOptions);
    };
  ...
  _createClass(Swiper, [{
    ...
    value: function render() {
      ...
      var className2Use = classnames(componentClassName, className, _defineProperty(_defineProperty(_defineProperty({}, "".concat(componentClassName, "--arrow"), arrow), "".concat(componentClassName, "--vertical"), vertical), "".concat(componentClassName, "--scale"), scale));
      var renderArrow = function renderArrow() {
        if (arrow) {
          ...
          var componentLeftBtnClassName = createClassName(componentClassName, 'btn-prev');
          var componentRightBtnClassName = createClassName(componentClassName, 'btn-next');
          var classNameLeftBtn = classnames(componentLeftBtnClassName, _defineProperty({}, "".concat(componentLeftBtnClassName, "--disable"), !prevBtnEnabled));
          var classNameRightBtn = classnames(componentRightBtnClassName, _defineProperty({}, "".concat(componentRightBtnClassName, "--disable"), !nextBtnEnabled));
      ...
      var renderIndicator = function renderIndicator() {
        if (indicator) {
          var componentIndicatorClassName = createClassName(componentClassName, 'indicators');
          return /*#__PURE__*/React.createElement("div", {
            className: componentIndicatorClassName
          }, scrollSnaps.map(function (_, index) {
            var componentDotsClassName = createClassName(componentClassName, 'dots');
            var className3Use = classnames(componentDotsClassName, _defineProperty({}, "".concat(componentDotsClassName, "--is-selected"), index === selectedIndex));
      ...
      var renderProgress = function renderProgress() {
        if (progress) {
          var componentProgressClassName = createClassName(componentClassName, 'progress');
          return /*#__PURE__*/React.createElement("div", {
      ...
      var renderSwiper = function renderSwiper() {
        var componentContainerClassName = createClassName(componentClassName, 'container');
      ...
      var renderThumb = function renderThumb() {
        if (thumb) {
          var componentThumbsClassName = createClassName('thumbs');
          ...
          if (childs) {
            ...
            React.Children.map(curChildren, function (child, index) {
              var componentThumbClassName = createClassName(componentThumbsClassName, 'thumb');
              var className4Use = classnames(componentThumbClassName, _defineProperty({}, "".concat(componentThumbClassName, "--actived"), index === selectedIndex));
          ...
          return /*#__PURE__*/React.createElement("div", {
            ...
            className: createClassName(componentClassName, 'container')
          }, thumbArr));
        }
        return null;
      };
