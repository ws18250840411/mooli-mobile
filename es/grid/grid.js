...
var Grid = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(Grid, [{
    ...
    value: function render() {
      ...
      var componentClassName = createClassName('grid');
      var className2Use = classnames(componentClassName, className, _defineProperty({}, "mooli-hairline--top mooli-hairline--left", border && !gutter));
