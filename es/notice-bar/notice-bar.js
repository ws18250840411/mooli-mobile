...
var componentClassName = createClassName('notice-bar');
var NoticeBar = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function NoticeBar(props) {
    ...
    _this.getTargetActive = function (pace) {
      if (pace) {
        return range(_this.active + pace, -1, _this.counts);
      }
      return _this.active;
    };
    ...
    _this.getLeftIconRender = function () {
      ...
      var leftIconClassName = createClassName(componentClassName, 'left-icon');
    ...
    _this.getRightIconRender = function () {
      ...
      var rightIconClassName = createClassName(componentClassName, 'right-icon');
    ...
    _this.getContentRender = function () {
      ...
      var className3Use = classnames(contentClassName, _defineProperty({}, "mooli-ellipsis", scrollable === false && !wrapable));
      ...
      }, /*#__PURE__*/React.createElement(NoticeBarContext.Provider, {
        value: {
          offset: _this.state.offset,
    ...
    _this.keyframeName = "".concat(componentClassName, "-").concat(getUniqueId());
    return _this;
  }
  _createClass(NoticeBar, [{
    ...
    value: function render() {
      ...
      var className2Use = classnames(componentClassName, className, _defineProperty(_defineProperty({}, "".concat(componentClassName, "--wrapable"), wrapable), "".concat(componentClassName, "--vertical"), vertical));
      var barStyle = {
        color: color,
