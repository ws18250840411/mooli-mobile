  ...
  _createClass(TabPane, [{
    ...
    value: function render() {
      ...
      var _a = this.props,
        ...
        rest = __rest(_a, ["style", "className", "title", "children"]);
      var componentClassName = createClassName('tab-pane');
      return /*#__PURE__*/React.createElement(TabContext.Consumer, null, function (value) {
        var isHidden = !(Number(_this.context.tabKey) === Number(value.activeKey));
...
TabPane.contextType = TabPaneContext;