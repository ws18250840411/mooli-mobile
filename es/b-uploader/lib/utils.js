...
export function drawFileInCanvas(file) {
...
export function canvasToFile(canvas, fileType, fileName, fileLastModified) {
...
export function adjustCanvasWidthOrHeight(canvas, maxWidthOrHeight) {
