...
var BUploader = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function BUploader(props) {
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                Toast("\u8BF7\u4E0A\u4F20 ".concat(this.props.accept, " \u683C\u5F0F\u56FE\u7247"));
                reject();
              ...
              case 17:
                _context.next = 19;
                return compress(f, this.props.compress);
              case 19:
    ...
    _this.handleOversize = function () {
      ...
      Toast("\u6587\u4EF6\u5927\u5C0F\u4E0D\u80FD\u8D85\u8FC7 ".concat(maxSize, "kb"));
    };
  ...
  _createClass(BUploader, [{
    ...
    value: function render() {
      ...
      var wrapperClassName = createClassName('buploader');
      var className2Use = classnames(wrapperClassName, className);
