...
var componentClassName = (0, _utils.createClassName)('popup');
var Popup = exports.default = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function Popup() {
    ...
    _this.renderIcon = function () {
      ...
      if (closeable && position === 'bottom') {
        var iconClassName = (0, _utils.createClassName)(componentClassName, 'close-icon');
        var className3Use = (0, _classnames3.default)(iconClassName, className, _defineProperty({}, "".concat(iconClassName, "--").concat(closeIconPosition), closeIconPosition));
  ...
  _createClass(Popup, [{
    ...
    value: function render() {
      ...
      var name = position === 'center' ? '' : (0, _utils.createClassName)(componentClassName, "slide-".concat(position));
      var popupTransition = Object.assign({
        timeout: 500,
        classNames: 'mooli-fade'
      }, transition);
      if (name) popupTransition['classNames'] = name;
      var className2Use = (0, _classnames3.default)(componentClassName, className, _defineProperty(_defineProperty({}, "".concat(componentClassName, "--round"), round), "".concat(componentClassName, "--").concat(position), position));
      return /*#__PURE__*/React.createElement(_popup.Popup, Object.assign({
...
Popup.propTypes = {
  ...
  closeProps: _propTypes.default.object,
