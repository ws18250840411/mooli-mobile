...
var Field = exports.default = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function Field(props) {
    ...
    _this.updateValue = function (val) {
      ...
      if (type === 'number' || type === 'digit') {
        ...
        curValue = (0, _utils.formatNumber)(curValue, isNumber, isNumber);
      }
  ...
  _createClass(Field, [{
    ...
    value: function render() {
      ...
      var componentClassName = (0, _utils.createClassName)('field');
      var className2Use = (0, _classnames5.default)(componentClassName, className, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "".concat(componentClassName, "--focused"), focused), "".concat(componentClassName, "--disabled"), disabled), "".concat(componentClassName, "--error"), error), "".concat(componentClassName, "--label--").concat(labelAlign), labelAlign), "".concat(componentClassName, "--min-height"), type === 'textarea' && !autoSize));
      var labelStyle = {};
      if (labelWidth) labelStyle.width = (0, _utils.addUnit)(labelWidth);
      ...
      var className3Use = (0, _classnames5.default)(labelClassName, labelClass, _defineProperty({}, "".concat(labelClassName, "--").concat(labelAlign), labelAlign));
      var genInput = function genInput() {
        var controlClassName = (0, _utils.createClassName)(componentClassName, 'control');
        var className4Use = (0, _classnames5.default)(controlClassName, _defineProperty({}, "".concat(controlClassName, "--").concat(inputAlign), inputAlign));
        var inputProps = {
          ref: _this2.inputRef,
        ...
        if (clearable && !readOnly && _this2.showClear()) {
          if (clearableIcon) {
            return /*#__PURE__*/React.createElement("span", {
              className: (0, _utils.createClassName)(componentClassName, 'clear'),
      ...
      var genChildren = function genChildren() {
        if (children) {
          return /*#__PURE__*/React.createElement("div", {
            className: (0, _utils.createClassName)(componentClassName, 'button')
          }, children);
        }
        return null;
      };
      var genWordLimit = function genWordLimit() {
        if (limit && maxLength) {
          ...
          return /*#__PURE__*/React.createElement("div", {
            className: (0, _utils.createClassName)(componentClassName, 'word-limit')
          }, /*#__PURE__*/React.createElement("span", {
            className: (0, _utils.createClassName)(componentClassName, 'word-num')
          }, count), "/", maxLength);
        }
      };
      var genMessage = function genMessage() {
        ...
        if (message) {
          var controlClassName = (0, _utils.createClassName)(componentClassName, 'error-message');
          var className5Use = (0, _classnames5.default)(controlClassName, _defineProperty({}, "".concat(controlClassName, "--").concat(errorMessageAlign), errorMessageAlign));
          return /*#__PURE__*/React.createElement("div", {
      ...
      var genPrefix = function genPrefix() {
        if (prefix && (focused || value)) {
          return /*#__PURE__*/React.createElement("span", {
            className: (0, _utils.createClassName)(componentClassName, 'prefix')
          }, prefix);
        }
        return null;
      };
      ...
      return /*#__PURE__*/React.createElement(_cell.default, Object.assign({
        title: renderLabel(),
        value: renderValue(),
        iconLeft: leftIcon,
        iconRight: rightIcon,
