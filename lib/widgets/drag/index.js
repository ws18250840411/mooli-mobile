...
var Drag = exports.Drag = /*#__PURE__*/function (_PureComponent) {
  ...
  function Drag(props) {
    ...
    _this._onTouchMove = function (event) {
      ...
      var _getPosition2 = (0, _utils2.getPosition)(event),
        x = _getPosition2.x,
        y = _getPosition2.y;
      var deltaX = x - _this.movePosition.x;
      var deltaY = y - _this.movePosition.y;
      var direction = (0, _utils2.getDirection)(deltaX, deltaY);
      var curMovePosition = {
        x: deltaX,
        y: deltaY,
        direction: direction
  ...
  _createClass(Drag, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.cloneElement(children, Object.assign(Object.assign({}, rest), {
