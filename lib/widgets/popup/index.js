...
var Popup = exports.Popup = /*#__PURE__*/function (_React$Component) {
  ...
  function Popup(props) {
    ...
    _this.transitionStatus = _Transition.EXITED;
    ...
    _this.rootInstance = /*#__PURE__*/_react.default.createRef();
    _this.popupInstance = /*#__PURE__*/_react.default.createRef();
    _this.maskInstance = /*#__PURE__*/_react.default.createRef();
    return _this;
  }
  _createClass(Popup, [{
    key: "getRootDOM",
    ...
    value: function renderPopupMask() {
      ...
      var classes = (0, _classnames3.default)(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-mask"), true), "".concat(prefixCls, "-mask-fixed"), fixed), maskProps.className, maskClassName);
      ...
      return /*#__PURE__*/_react.default.createElement(TransitionComponent, Object.assign({
        enter: true,
        exit: true,
        appear: true,
      ...
      }), /*#__PURE__*/_react.default.createElement(MaskComponent, Object.assign({}, maskProps, {
    ...
    value: function render() {
      ...
      var rootComponentProps = Object.assign(Object.assign({}, rootProps), {
        className: (0, _classnames3.default)("".concat(prefixCls, "-root"), rootClassName, rootProps.className),
      ...
      var classes = (0, _classnames3.default)(prefixCls, _defineProperty({}, "".concat(prefixCls, "-fixed"), fixed), className);
      var style2Use = {};
      if (duration) {
        style2Use.animationDuration = "".concat(duration, "s");
      }
      var TransitionComponent = transition.classNames ? _CSSTransition.default : _Transition.default;
      var popup = /*#__PURE__*/_react.default.createElement(RootComponent, Object.assign({}, rootComponentProps, {
        ref: this.rootInstance
      }), !disableMask && this.renderPopupMask(), wrapContent( /*#__PURE__*/_react.default.createElement(TransitionComponent, Object.assign({
        enter: true,
        exit: true,
        appear: true,
        addEndListener: function addEndListener(_, cb) {
        ...
        return /*#__PURE__*/_react.default.createElement(Component, Object.assign({}, childProps, {
