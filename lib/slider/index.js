...
var componentClassName = (0, _utils.createClassName)('slider');
var Slider = exports.default = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function Slider(props) {
    ...
    _this.renderButton = function () {
      ...
      return /*#__PURE__*/React.createElement(_drag.Drag, {
        ...
        className: (0, _utils.createClassName)(componentClassName, 'button-wrapper-right'),
    ...
    _this.renderButtonGroup = function () {
      ...
      return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_drag.Drag, {
        onTouchStart: function onTouchStart() {
          _this.index = 0;
          _this.onTouchStart();
        },
        ...
        tabIndex: disabled ? -1 : 0,
        className: (0, _utils.createClassName)(componentClassName, 'button-wrapper-left'),
        onClick: function onClick(e) {
          return e.stopPropagation();
        }
      }, button || ( /*#__PURE__*/React.createElement("div", {
  ...
  _createClass(Slider, [{
    ...
    get: function get() {
      ...
      var size = (0, _utils.addUnit)(buttonSize);
      return {
        width: size,
        height: size
      };
    ...
    value: function render() {
      ...
      wrapperStyle[crossAxis] = (0, _utils.addUnit)(barHeight);
      // 长度百分比
      ...
      var className2Use = (0, _classnames2.default)(componentClassName, className, _defineProperty(_defineProperty({}, "".concat(componentClassName, "--disabled"), disabled), "".concat(componentClassName, "--vertical"), vertical));
      return /*#__PURE__*/React.createElement("div", Object.assign({
        ...
        className: (0, _utils.createClassName)(componentClassName, 'bar'),
        style: barStyle
