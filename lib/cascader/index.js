...
var _tabPane = _interopRequireDefault(require("../tabs/tab-pane"));
...
var componentClassName = (0, _utils.createClassName)('cascader');
var Cascader = exports.default = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function Cascader(props) {
    ...
    _this.renderHeader = function () {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        className: (0, _utils.createClassName)(componentClassName, 'title')
      }, title), closeable ? ( /*#__PURE__*/React.createElement(_icon.default, {
        name: "cross",
        className: (0, _utils.createClassName)(componentClassName, 'close-icon'),
    ...
    _this.renderOptions = function (options, selectedOption, tabIndex) {
      var renderOption = function renderOption(option) {
        ...
        var optionClassName = (0, _utils.createClassName)(componentClassName, 'option');
        var className3Use = (0, _classnames.default)(optionClassName, {
          selected: isSelected
        });
        ...
        }, /*#__PURE__*/React.createElement("span", null, option[_this.textKey]), isSelected ? ( /*#__PURE__*/React.createElement(_icon.default, {
          name: "success",
          className: (0, _utils.createClassName)(componentClassName, 'selected-icon')
        })) : null);
      };
      return /*#__PURE__*/React.createElement("ul", {
        className: (0, _utils.createClassName)(componentClassName, 'options')
      }, options.length > 0 ? options.map(renderOption) : ( /*#__PURE__*/React.createElement("div", {
        className: (0, _utils.createClassName)(componentClassName, 'loading')
    ...
    _this.renderTab = function (item, tabIndex) {
      ...
      var tabClassName = (0, _utils.createClassName)(componentClassName, 'tab');
      var className3Use = (0, _classnames.default)(tabClassName, {
        unselected: !selectedOption
      });
      return /*#__PURE__*/React.createElement(_tabPane.default, {
        key: "tabpane",
        title: title,
        className: className3Use
    ...
    _this.renderTabs = function () {
      var tabsClassName = (0, _utils.createClassName)(componentClassName, 'tabs');
