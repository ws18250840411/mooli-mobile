...
var componentClassName = (0, _utils.createClassName)('action-sheet');
var ActionSheet = exports.default = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function ActionSheet() {
    ...
    _this.renderCancel = function () {
      ...
      if (cancelText) {
        return /*#__PURE__*/React.createElement("div", {
          className: (0, _utils.createClassName)(componentClassName, 'gap')
        }, /*#__PURE__*/React.createElement(_button.default, {
          bordered: false,
          className: (0, _utils.createClassName)(componentClassName, 'cancel'),
          onClick: onCancel
        }, cancelText));
      }
      return null;
    ...
    _this.renderDescription = function () {
      ...
      if (description) {
        return /*#__PURE__*/React.createElement("div", {
          className: (0, _utils.createClassName)(componentClassName, 'description')
    ...
    _this.renderOption = function (item, index) {
      ...
      var Content = loading ? ( /*#__PURE__*/React.createElement(_loading.default, {
        className: (0, _utils.createClassName)(componentClassName, 'loading-icon')
      })) : ( /*#__PURE__*/React.createElement(React.Fragment, null, name && ( /*#__PURE__*/React.createElement("span", {
        className: (0, _utils.createClassName)(componentClassName, 'name')
      }, name)), subname && ( /*#__PURE__*/React.createElement("div", {
        className: (0, _utils.createClassName)(componentClassName, 'subname')
      }, subname))));
      var buttonClassName = (0, _utils.createClassName)(componentClassName, 'item');
      var className4Use = (0, _classnames2.default)(buttonClassName, className, _defineProperty(_defineProperty({}, "".concat(buttonClassName, "--loading"), loading), "".concat(buttonClassName, "--disabled"), disabled));
    ...
    _this.renderContent = function () {
      ...
      return /*#__PURE__*/React.createElement("div", {
        className: (0, _utils.createClassName)(componentClassName, 'content')
