...
var componentClassName = (0, _utils.createClassName)('bcamera');
var BCamera = exports.default = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function BCamera(props) {
    ...
    _this.renderFooter = function () {
      ...
      var className3Use = (0, _classnames3.default)(footerClassName, _defineProperty({}, "".concat(componentClassName, "--isFinish"), _this.state.isFinish));
      return /*#__PURE__*/React.createElement("div", {
        className: className3Use
      }, /*#__PURE__*/React.createElement("div", {
        className: (0, _utils.createClassName)(componentClassName, 'footer-body')
      }, _this.state.isFinish ? ( /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
        className: (0, _utils.createClassName)(componentClassName, 'remake'),
        onClick: _this.getScreenshot
      }, "Remake"), /*#__PURE__*/React.createElement("span", {
        className: (0, _utils.createClassName)(componentClassName, 'kirim'),
        onClick: _this.getScreenshot
  ...
  _createClass(BCamera, [{
    ...
    value: function render() {
      ...
      var className2Use = (0, _classnames3.default)(componentClassName, className, _defineProperty({}, "".concat(componentClassName, "--").concat(type), type));
      var _getViewportSize = (0, _utils.getViewportSize)(),
        width = _getViewportSize.width;
      return /*#__PURE__*/React.createElement("div", {
        className: className2Use,
        style: style
      }, /*#__PURE__*/React.createElement("div", {
        className: (0, _utils.createClassName)(componentClassName, 'camera')
      }, /*#__PURE__*/React.createElement(_camera.default, Object.assign({
        ref: this.cameraRef,
