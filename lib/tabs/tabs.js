...
var _tabContext = _interopRequireDefault(require("./lib/tabContext"));
var _tabPaneContext = _interopRequireDefault(require("./lib/tabPaneContext"));
...
var componentClassName = (0, _utils2.createClassName)('tabs');
var Tabs = exports.default = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function Tabs(props) {
    ...
    _this.scrollIntoView = function (immediate) {
      ...
      (0, _utils.scrollLeftTo)(tabBar, to, immediate ? 0 : Number(duration), type);
    };
    _this.setLine = function () {
      ...
      if (tabEle) {
        ...
        if (direction === 'horizontal') {
          ...
          lineStyle = {
            width: (0, _utils2.addUnit)(lineWidth),
        ...
        if (lineHeight) {
          var height = (0, _utils2.addUnit)(lineHeight);
    ...
    _this.renderLine = function () {
      if (_this.props.type === 'line') {
        var underlineClassName = (0, _utils2.createClassName)(componentClassName, 'underline');
    ...
    _this.renderNavs = function () {
      ...
      var navClassName = (0, _utils2.createClassName)(componentClassName, 'nav');
      var className4Use = (0, _classnames4.default)(navClassName, _defineProperty(_defineProperty({}, "".concat(navClassName, "--").concat(type), type), "".concat(navClassName, "--complete"), _this.scrollable));
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        return /*#__PURE__*/React.createElement(_tabBar.default, Object.assign({
          key: index,
          type: type,
    ...
    _this.renderWrap = function () {
      ...
      var wrapClassName = (0, _utils2.createClassName)(componentClassName, 'wrap');
      var isVertical = direction === 'vertical';
      var className5Use = (0, _classnames4.default)(wrapClassName, _defineProperty(_defineProperty(_defineProperty({}, "mooli-hairline--top-bottom", type === 'line' && border && !isVertical), "mooli-hairline--right", isVertical && border), "".concat(wrapClassName, "--scrollable"), _this.scrollable));
      var wrap = /*#__PURE__*/React.createElement("div", {
        className: className5Use
      }, _this.renderNavs());
      if (sticky) {
        return /*#__PURE__*/React.createElement(_sticky.default, {
    ...
    _this.renderPanes = function () {
      ...
      var contentClassName = (0, _utils2.createClassName)(componentClassName, 'content');
      ...
      return /*#__PURE__*/React.createElement(_tabContent.default, {
        ...
        return /*#__PURE__*/React.createElement(_tabPaneContext.default.Provider, {
          key: tabKey,
          value: {
            tabKey: tabKey
          }
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      var className2Use = (0, _classnames4.default)(componentClassName, className, _defineProperty(_defineProperty({}, "".concat(componentClassName, "--").concat(type), type), "".concat(componentClassName, "--").concat(direction), direction));
