...
var TabContent = exports.default = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function TabContent(props) {
    ...
    _this.genChildren = function () {
      if (_this.props.animated) {
        var componentClassName = (0, _utils.createClassName)('tabs');
        return /*#__PURE__*/React.createElement("div", {
          className: (0, _utils.createClassName)(componentClassName, 'track'),
          style: _this.styles
  ...
  _createClass(TabContent, [{
    ...
    value: function render() {
      ...
      var className2Use = (0, _classnames2.default)(className, _defineProperty(_defineProperty({}, "".concat(className, "--animated"), animated), "".concat(className, "--").concat(direction), direction));
      if (animated) {
