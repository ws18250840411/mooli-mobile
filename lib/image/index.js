...
var componentClassName = (0, _utils.createClassName)('image');
var Image = exports.default = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function Image(props) {
    ...
    _this.renderLoadingIcon = function () {
      ...
      var iconClassName = (0, _utils.createClassName)(componentClassName, 'loading-icon');
      var className3Use = (0, _classnames2.default)(iconClassName, iconPrefix);
    ...
    _this.renderErrorIcon = function () {
      ...
      var errorClassName = (0, _utils.createClassName)(componentClassName, 'error-icon');
      var className4Use = (0, _classnames2.default)(errorClassName, iconPrefix);
    ...
    _this.renderPlaceholder = function () {
      ...
      if (error && showError) {
        return /*#__PURE__*/React.createElement("div", {
          className: (0, _utils.createClassName)(componentClassName, 'error')
    ...
    _this.renderImage = function () {
      ...
      var imgClassName = (0, _utils.createClassName)(componentClassName, 'img');
  ...
  _createClass(Image, [{
    ...
    value: function render() {
      ...
      var componentClassName = (0, _utils.createClassName)('image');
      var className2Use = (0, _classnames2.default)(componentClassName, className, _defineProperty({}, "".concat(componentClassName, "--round"), round));
      var style2Use = {};
      if (width) style2Use.width = (0, _utils.addUnit)(width);
      if (height) style2Use.height = (0, _utils.addUnit)(height);
      if (radius) {
        style2Use.overflow = 'hidden';
        style2Use.borderRadius = (0, _utils.addUnit)(radius);
      }
...
Image.propTypes = {
  ...
  errorIndicator: _propTypes.default.node,
