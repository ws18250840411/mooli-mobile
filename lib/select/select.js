...
var Select = exports.default = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function Select(props) {
    ...
    _this.search = new _Search.default('value', 'label');
    return _this;
  }
  _createClass(Select, [{
    ...
    value: function render() {
      ...
      var componentClassName = (0, _utils.createClassName)('select');
      var className2Use = (0, _classnames.default)(componentClassName, className);
      return /*#__PURE__*/React.createElement("div", {
        className: className2Use
      }, /*#__PURE__*/React.createElement(_search.default, Object.assign({
        ...
        return /*#__PURE__*/React.createElement(_option.default, {
          key: i,
          value: item.value,
          label: item.label,
