...
var componentClassName = (0, _utils.createClassName)('collapse-item');
var CollapseItem = exports.default = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function CollapseItem(props) {
    ...
    _this.genTitle = function () {
      ...
      var className3Use = (0, _classnames3.default)(titleClassName, _defineProperty(_defineProperty(_defineProperty({}, "".concat(titleClassName, "--disabled"), disabled), "".concat(titleClassName, "--expanded"), _this.expanded), "".concat(titleClassName, "--borderless"), !_this.context.border));
  ...
  _createClass(CollapseItem, [{
    ...
    value: function render() {
      ...
      var className2Use = (0, _classnames3.default)(componentClassName, className, _defineProperty({}, "".concat(componentClassName, "--border"), index && border));
      return /*#__PURE__*/React.createElement("div", {
...
CollapseItem.contextType = _context.default;