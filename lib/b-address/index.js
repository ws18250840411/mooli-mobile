...
var componentClassName = (0, _utils2.createClassName)('baddress');
var AddressLevel;
...
var BAddress = exports.default = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(BAddress, [{
    ...
    value: function hasLast(type) {
      return Number((0, _utils.getActiveTab)(this.props.value)) === Number(AddressLevel[type]);
    }
  }, {
    key: "getAddressData",
    ...
    value: function renderLoad() {
      ...
      if (loading) {
        return /*#__PURE__*/React.createElement("div", {
          className: (0, _utils2.createClassName)(componentClassName, 'loading')
    ...
    value: function renderTabPanItem(options, selectValue, type) {
      var _this8 = this;
      if (options.length > 0) {
        var tabItemClassName = (0, _utils2.createClassName)(componentClassName, 'tabpan-item');
        return /*#__PURE__*/React.createElement("ul", {
          className: tabItemClassName
        }, options.map(function (item) {
          var className3Use = (0, _classnames.default)({
    ...
    value: function renderTabPan() {
      ...
      if (provinceData.length > 0) {
        ...
        var pData = (0, _utils.customeFieldNames)(provinceData, {
          text: text,
          value: value
        });
        tabpans.push( /*#__PURE__*/React.createElement(_tabPane.default, {
      ...
      if (cityData.length > 0) {
        ...
        var cData = (0, _utils.customeFieldNames)(cityData, {
          text: _text,
          value: _value
        });
        tabpans.push( /*#__PURE__*/React.createElement(_tabPane.default, {
      ...
      if (districtData.length > 0) {
        ...
        var dData = (0, _utils.customeFieldNames)(districtData, {
          text: _text2,
          value: _value2
        });
        tabpans.push( /*#__PURE__*/React.createElement(_tabPane.default, {
      ...
      if (villageData.length > 0) {
        ...
        var vData = (0, _utils.customeFieldNames)(villageData, {
          text: _text3,
          value: _value3
        });
        tabpans.push( /*#__PURE__*/React.createElement(_tabPane.default, {
    ...
    value: function renderTabs() {
      var _this9 = this;
      var tabsClassName = (0, _utils2.createClassName)(componentClassName, 'tabs');
