...
exports.adjustCanvasWidthOrHeight = adjustCanvasWidthOrHeight;
exports.canvasToFile = canvasToFile;
exports.cleanupCanvasMemory = cleanupCanvasMemory;
exports.drawFileInCanvas = drawFileInCanvas;
exports.drawImageInCanvas = drawImageInCanvas;
exports.getDataUrlFromFile = getDataUrlFromFile;
exports.getFilefromDataUrl = getFilefromDataUrl;
exports.getNewCanvasAndCtx = getNewCanvasAndCtx;
...
// @ts-ignore
var OffscreenCanvas = isBrowser && window.OffscreenCanvas;
...
function drawImageInCanvas(img) {
  var _getNewCanvasAndCtx = getNewCanvasAndCtx(img.width, img.height),
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 13:
          img = _context.sent;
        case 14:
          canvas = drawImageInCanvas(img);
          return _context.abrupt("return", [img, canvas]);
        case 16:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 8:
          ...
          _context2.next = 11;
          return getFilefromDataUrl(dataUrl, fileName, fileLastModified);
        case 11:
          file = _context2.sent;
        case 12:
...
function adjustCanvasWidthOrHeight(canvas, maxWidthOrHeight) {
