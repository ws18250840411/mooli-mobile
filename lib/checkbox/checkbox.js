...
var componentClassName = (0, _utils.createClassName)('checkbox');
var Checkbox = exports.default = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function Checkbox(props) {
    ...
    _this.genIcon = function () {
      ...
      var iconClassName = (0, _utils.createClassName)(componentClassName, 'icon');
      var className3Use = (0, _classnames4.default)(iconClassName, _defineProperty(_defineProperty(_defineProperty({}, "".concat(iconClassName, "--").concat(shape), shape), "".concat(iconClassName, "--disabled"), _this.isDisabled), "".concat(iconClassName, "--checked"), _this.checked));
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        key: "checkbox-icon",
        style: {
          fontSize: (0, _utils.addUnit)(curIconSize)
        },
        className: className3Use
      }, iconRender || /*#__PURE__*/React.createElement(_icon.default, {
        name: "success",
    ...
    _this.genLabel = function () {
      ...
      var className3Use = (0, _classnames4.default)(labelClassName, _defineProperty(_defineProperty({}, "".concat(labelClassName, "--").concat(labelPosition), labelPosition), "".concat(labelClassName, "--disabled"), _this.isDisabled));
  ...
  _createClass(Checkbox, [{
    ...
    value: function render() {
      ...
      var className2Use = (0, _classnames4.default)(componentClassName, className, _defineProperty(_defineProperty(_defineProperty({}, "".concat(componentClassName, "--").concat(this.context.direction), this.context.direction), "".concat(componentClassName, "--disabled"), this.isDisabled), "".concat(componentClassName, "--label-disabled"), labelDisabled));
...
Checkbox.propTypes = {
  ...
  labelDisabled: _propTypes.default.bool,
...
Checkbox.contextType = _context.default;
