...
var CheckboxGroup = exports.default = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(CheckboxGroup, [{
    ...
    value: function render() {
      var _a = this.props,
        ...
        rest = __rest(_a, ["value", "max", "disabled", "iconSize", "checkedColor", "direction", "className", "style", "children", "onChange"]);
      var onSwitch = function onSwitch(value) {
        if (onChange) onChange(value);
      };
      var componentClassName = (0, _utils.createClassName)('checkbox-group');
      var className2Use = (0, _classnames2.default)(componentClassName, className, _defineProperty({}, "".concat(componentClassName, "--").concat(direction), direction));
