...
var ImagePreview = exports.default = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(ImagePreview, [{
    ...
    value: function render() {
      ...
      var componentClassName = (0, _utils.createClassName)('image-preview');
      ...
      var renderClose = function renderClose() {
        if (closeable) {
          ...
          var className3Use = (0, _classnames3.default)(iconClassName, _defineProperty({}, "".concat(iconClassName, "--").concat(closeIconPosition), closeIconPosition));
      ...
      var renderSwiper = function renderSwiper() {
        if (images && images.length > 0) {
          return /*#__PURE__*/React.createElement(_swiper.default, Object.assign({
            loop: true,
