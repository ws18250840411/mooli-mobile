...
var Sticky = exports.default = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function Sticky(props) {
    ...
    _this.onscroll = function () {
      if (!_this.rootRef.current || (0, _utils.isHidden)(_this.rootRef.current)) return;
      var scrollTop = (0, _utils.getScrollTop)(window);
      var topToPageTop = (0, _utils.getElementTop)(_this.rootRef.current);
      if (_this.container) {
  ...
  _createClass(Sticky, [{
    ...
    value: function componentDidMount() {
      if (this.rootRef.current) {
        ...
        this.offsetTopPx = (0, _utils.unitToPx)(this.props.offsetTop);
      }
    }
  }, {
    ...
    value: function render() {
      ...
      var componentClassName = (0, _utils.createClassName)('sticky');
      var className2Use = (0, _classnames2.default)(componentClassName, className, _defineProperty({}, "".concat(componentClassName, "--fixed"), fixed));
      var rootStyle = {
