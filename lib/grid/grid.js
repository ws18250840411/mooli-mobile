...
var Grid = exports.default = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(Grid, [{
    ...
    value: function render() {
      var _a = this.props,
        _a$gutter = _a.gutter,
        gutter = _a$gutter === void 0 ? 0 : _a$gutter,
        column = _a.column,
        _a$square = _a.square,
        square = _a$square === void 0 ? false : _a$square,
        _a$border = _a.border,
        ...
        rest = __rest(_a, ["gutter", "column", "square", "border", "direction", "className", "style", "children"]);
      ...
      var componentClassName = (0, _utils.createClassName)('grid');
      var className2Use = (0, _classnames2.default)(componentClassName, className, _defineProperty({}, "mooli-hairline--top mooli-hairline--left", border && !gutter));
      var columnNum = column || React.Children.count(children);
...
Grid.propTypes = {
  gutter: _propTypes.default.oneOfType([_propTypes.default.number, _propTypes.default.string]),
