...
var componentClassName = (0, _utils2.createClassName)('picker-column');
var PickerColumn = exports.PickerColumn = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function PickerColumn(props) {
    ...
    _this.isOptionDisabled = function (option) {
      return (0, _utils2.isObject)(option) && option.disabled;
    };
    ...
    _this.getOptionText = function (option) {
      if ((0, _utils2.isObject)(option) && _this.props.valueKey in option) {
        // @ts-ignore
    ...
    _this.genOptions = function () {
      ...
      return options.map(function (option, index) {
        ...
        var itemClassName = (0, _utils2.createClassName)(componentClassName, 'item');
        var className2Use = (0, _classnames2.default)(itemClassName, _defineProperty(_defineProperty({}, "".concat(itemClassName, "--selected"), index === currentIndex), "".concat(itemClassName, "--disabled"), disabled));
    ...
    _this.getIndexByOffset = function (offset) {
      return (0, _utils2.range)(Math.round(-offset / _this.props.itemHeight), 0, _this.count - 1);
    };
    _this.onTouchStart = function () {
      var readonly = _this.props.readonly;
      if (readonly) return;
      if (_this.moving) {
        var translateY = (0, _utils.getElementTranslateY)(_this.wrapper.current);
        _this.setState({
    ...
    _this.onTouchMove = function (_event, position) {
      ...
      _this.moving = true;
      _this.setState({
        offset: (0, _utils2.range)(_this.startOffset + position.y, -(_this.count * itemHeight), itemHeight)
      });
      var now = Date.now();
  ...
  _createClass(PickerColumn, [{
    ...
    value: function adjustIndex(index) {
      index = (0, _utils2.range)(index, 0, this.count);
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(_drag.Drag, {
        ...
        className: (0, _utils2.createClassName)(componentClassName, 'wrapper'),
...
PickerColumn.propTypes = {
  initialOptions: _propTypes.default.array,
