...
var componentClassName = (0, _utils.createClassName)('picker');
var Picker = exports.default = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function Picker(props) {
    ...
    _this.genTitle = function () {
      ...
      if (title) {
        ...
        var className3Use = (0, _classnames.default)(titleClassName, 'mooli-ellipsis');
    ...
    _this.genConfirm = function () {
      ...
      if (confirm || confirmButtonText) {
        return /*#__PURE__*/React.createElement("button", {
          key: "picker-confirm",
          type: "button",
          className: (0, _utils.createClassName)(componentClassName, 'confirm'),
    ...
    _this.genToolbar = function () {
      ...
      if (showToolbar) {
        return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
          className: (0, _utils.createClassName)(componentClassName, 'toolbar')
    ...
    _this.genColumns = function () {
      ...
      return /*#__PURE__*/React.createElement("div", {
        className: (0, _utils.createClassName)(componentClassName, 'columns'),
        style: columnsStyle
      }, _this.genColumnItems(), /*#__PURE__*/React.createElement("div", {
        className: (0, _utils.createClassName)(componentClassName, 'mask'),
        style: maskStyle
      }), /*#__PURE__*/React.createElement("div", {
        className: (0, _classnames.default)((0, _utils.createClassName)(componentClassName, 'frame'), 'mooli-hairline-unset--top-bottom'),
        style: frameStyle
      }));
    };
    _this.genColumnItems = function () {
      ...
      return formattedColumns.map(function (item, columnIndex) {
        var _a;
        return /*#__PURE__*/React.createElement(_column.PickerColumn, {
          key: columnIndex,
          readonly: readonly,
          valueKey: valueKey,
          allowHtml: allowHtml,
  ...
  _createClass(Picker, [{
    ...
    get: function get() {
      ...
      return itemHeight ? (0, _utils.unitToPx)(itemHeight) : DEFAULT_ITEM_HEIGHT;
    }
  }, {
    key: "dataType",
    get: function get() {
...
Picker.propTypes = {
  ...
  toolbarPosition: _propTypes.default.string,
