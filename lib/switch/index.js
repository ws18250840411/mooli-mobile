...
var componentClassName = (0, _utils.createClassName)('switch');
var Switch = exports.default = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(Switch, [{
    ...
    value: function render() {
      ...
      var className2Use = (0, _classnames2.default)(componentClassName, className, _defineProperty(_defineProperty(_defineProperty({}, "".concat(componentClassName, "--checked"), this.checked), "".concat(componentClassName, "--loading"), loading), "".concat(componentClassName, "--disabled"), disabled));
      var styles = {
      ...
      return /*#__PURE__*/React.createElement("div", Object.assign({
        ...
        className: (0, _utils.createClassName)(componentClassName, 'node')
      }, loading && ( /*#__PURE__*/React.createElement(_loading.default, {
        color: this.checked ? activeColor : inactiveColor,
        className: (0, _utils.createClassName)(componentClassName, 'load')
      })), children));
    }
  }]);
  return Switch;
