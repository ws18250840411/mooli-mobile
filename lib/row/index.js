...
var Row = exports.default = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(Row, [{
    ...
    value: function render() {
      var _a = this.props,
        ...
        rest = __rest(_a, ["align", "justify", "gutter", "wrap", "className", "style", "children"]);
      ...
      var componentClassName = (0, _utils.createClassName)('row');
      var className2Use = (0, _classnames2.default)(componentClassName, className, _defineProperty(_defineProperty(_defineProperty({}, "".concat(componentClassName, "--align"), align), "".concat(componentClassName, "--flex ").concat(componentClassName, "--justify-").concat(justify), justify), "".concat(componentClassName, "--no-wrap"), !wrap));
      var style2Use = {};
